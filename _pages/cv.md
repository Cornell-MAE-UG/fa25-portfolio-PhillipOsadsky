...
[Download my CV]({{ "/assets/Phillip Resume.pdf" | relative_url }}) in PDF format.


**Email:** [pwo5@cornell.edu](mailto:pwo5@cornell.edu) | | | **Phone:** +603 416 3842
...
#### Projects
- **Open Design Project – Spotted Lanternfly Mitigation System**:  
  - Led a 5-person engineering team through the full product development cycle to design a mechanical mitigation system reducing Spotted Lanternfly contamination during mechanized grape harvesting.
  - Designed and fabricated prototypes using Fusion 360 CAD and McMaster Carr-built components, applying  systematic analysis to optimize insect displacement while preserving harvest and machine efficiency.
  - Presented technical findings and prototype performance trade-offs to agricultural researchers, defending engineering decisions based on data analysis.

- **Low Earth Orbit Satellite Systems and Telescope Researcher**:  
  - Conducted a quantitative systems level analysis of how LEO satellite constellations impact ground based astronomical imaging performance. 
  - Analyzed orbital deployment data, observation geometry, and detection rates to assess satellite visibility and interference mechanisms regarding ongoing Starlink constellation launches.
  - Performed time series trend analysis and projections to estimate telescope disruption rates through 2030 under expanding constellation scenarios and generated data visualizations.
  - Presented a 19 page technical research paper, translating complex orbital and statistical findings into actionable insights for mitigation strategies.

---

#### Work Experience
- **Water Wonders Swim School**  
  June, 2025 - July, 2025 
  - Worked with kids of ages 4-12 at all different levels in the pool and helped them be comfortable in the water.
  - Taught basic survival skills all the way to pre competitive swimming coaching.	
